...
@interface NSString (ZSFTPManagerNSStringAdditions)
...
typedef enum {
    ZSFMStreamFailureReasonNone,
    ZSFMStreamFailureReasonReadError,
    ZSFMStreamFailureReasonWriteError,
    ZSFMStreamFailureReasonGeneralError,
    ZSFMStreamFailureReasonAborted
} ZSFMStreamFailureReason;

typedef enum {
    _ZSFMCurrentActionUploadFile,
    _ZSFMCurrentActionCreateNewFolder,
    _ZSFMCurrentActionContentsOfServer,
    _ZSFMCurrentActionDownloadFile,
    _ZSFMCurrentActionSOCKET,
    _ZSFMCurrentActionNone
} _ZSFMCurrentAction;
...
@protocol ZSFTPManagerDelegate <NSObject>
@optional
...
@interface ZSFTPManager : NSObject <NSStreamDelegate> {
    CFRunLoopRef currentRunLoop;
    
    _ZSFMCurrentAction action;
...
@property (assign) id<ZSFTPManagerDelegate>delegate;
 ...
 */
- (BOOL) deleteFile:(NSString *)absolutePath fromServer:(ZSFMServer *)server DEPRECATED_ATTRIBUTE;
